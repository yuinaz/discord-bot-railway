...
<rect rx="8" width="160" height="40" fill="url(#g)"/><path d="M18 10l10 5v6c0 6-6 9-10 10-4-1-10-4-10-10v-6l10-5z" fill="#111827" opacity=".95"/>  # noqa: E501



<text x="48" y="26" font-family="Inter,Segoe UI,Arial" font-size="16" fill="#fff" font-weight="700">SatpamBot</text></svg>""",  # noqa: E501
...
if login_html.exists():
    ...
    html = re.sub(
        ...
        lambda m: (
            ...
            f'<form{m.group(1)} class="login-form">'
