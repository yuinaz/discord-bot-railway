...
def _register_dashboard_blueprint_with_fallback(app):
    ...
    Daftarkan blueprint dashboard



    fallback aktif jika import webui gagal.
...
def main():
    ...
    if not any_touched:
        ...
        print(
            ...
            "[patch] Nothing changed. If /dashboard/login still 404, ensure create_app() is in app.py/app_dashboard.py"
