...
def main():
    ...
    if ensure_file(
        ...
        DASH / "static" / "css" / "login_exact.css",
    ...
    if ensure_file(
        ...
        DASH / "static" / "css" / "neo_aurora_plus.css",
    ...
    if ensure_file(
        ...
        DASH / "static" / "js" / "neo_dashboard_live.js",
    ...
    if ensure_file(
        ...
        DASH / "themes" / "gtake" / "templates" / "login.html",
    ...
    if ensure_file(
        ...
        DASH / "themes" / "gtake" / "templates" / "dashboard.html",
    ...
    if ensure_file(
        ...
        DASH / "themes" / "gtake" / "static" / "theme.css",
        ...
        ".pill{display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;background:#fff1;border:1px solid #fff3;color:#e6e8ee;text-decoration:none;} "  # noqa: E501
