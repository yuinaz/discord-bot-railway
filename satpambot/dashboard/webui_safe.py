...
<div class="lg-wrap">
  ...
  <div class="lg-card">
    ...
    <form method="post" action="/dashboard/login" class="lg-form">
      ...
      <div class="lg-row"><span class="lg-ico">🔒</span><input type="password" name="password" placeholder="Password" required></div>  # noqa: E501
...
def static_files(rest: str):
    ...
    if rest.endswith(".css"):
        ...
        return (
            ...
            "/* fallback css */ .topbar{display:flex;gap:16px;padding:10px;background:#101828;color:#fff}.container{padding:20px}.grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px}.card{background:#111827aa;padding:16px;border-radius:12px;color:#e5e7eb}",  # noqa: E501
