    ...
    try:
        ...
        for g in guilds:
            ...
            try:
                ...
                data["channel_count"] += len(getattr(g, "channels", []) or [])
            ...
            try:
                ...
                for ch in getattr(g, "text_channels", []) or []:
                    ...
                    try:
                        ...
                        data["thread_count"] += len(getattr(ch, "threads", []) or [])
            ...
            try:
                ...
                for m in getattr(g, "members", []) or []:
                    ...
                    sval = getattr(st, "value", st)



                    if str(sval) in ("online", "idle", "dnd"):
        ...
        try:
            ...
            data["latency_ms"] = int(float(getattr(b, "latency", 0.0)) * 1000.0)
