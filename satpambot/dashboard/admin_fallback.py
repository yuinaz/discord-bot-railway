...
<body style="background:#0f1320;color:#e6e6e6;font-family:system-ui,Segoe UI,Arial,sans-serif;">
  ...
  <div style="max-width:720px;margin:8vh auto;padding:24px;border-radius:16px;background:#161b2e;border:1px solid #28314f">  # noqa: E501
...
<style>
  ...
  background:#0f1320; color:#e6e6e6; font-family:system-ui,Segoe UI,Arial,sans-serif; {bgstyle} }}
  ...
  background:#161b2e; border:1px solid #28314f; box-shadow:0 10px 30px rgba(0,0,0,.35) }}
  ...
  border:1px solid #334; outline:none; background:#0b0f1a; color:#e6e6e6; margin-top:10px }}
