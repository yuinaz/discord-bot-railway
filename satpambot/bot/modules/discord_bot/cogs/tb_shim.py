...
class TBShimFormatted(commands.Cog):
    ...
    - Tidak ada aksi ban sungguhan



    hanya kirim embed verifikasi untuk workflow moderator.
    ...
    @commands.command(
        ...
        help="Simulasi testban: `!tb [@user] [alasan?]` (tanpa parameter pun tetap jalan).",
        ...
        *,
        ...
        def _ok_embed(target: discord.Member) -> discord.Embed:
            ...
            try:
                ...
                av = getattr(getattr(target, "display_avatar", None), "url", None) or getattr(



                    getattr(target, "avatar", None), "url", None
    ...
    async def tb_error(self, ctx: commands.Context, error: Exception) -> None:
        ...
        if isinstance(error, commands.MissingPermissions):
            ...
            await ctx.reply(
                ...
                "⚠️ Hanya moderator/admin yang bisa memakai `!tb` (butuh izin **Ban Members**).",
