...
class Pager(discord.ui.View):
    ...
    async def first(self, i, _):



        await self._flip(i, to=0)
    ...
    async def prev(self, i, _):



        await self._flip(i, delta=-1)
    ...
    async def last(self, i, _):



        await self._flip(i, to=10**6)
