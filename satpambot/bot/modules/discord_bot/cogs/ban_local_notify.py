...
class BanLocalNotify(commands.Cog):
    ...
    async def _maybe_call(self, fn: Callable[..., Any], **ctx):
        ...
        try:
            ...
            for name, p in sig.parameters.items():
                ...
                if low in ("guild", "g"):
                ...
                elif low in ("user", "member", "target"):
                ...
                elif low in ("moderator", "mod", "by", "actor"):
                    ...
                    kwargs[name] = ctx.get("message_id")
    ...
    async def _probe_embed_from_cogs(
        ...
        self, guild, user, reason, moderator, channel, message_id
    ...
    def _fallback_embed(self, guild, user, reason, moderator, channel, message_id) -> discord.Embed:
        ...
        if moderator:
            ...
            emb.add_field(name="Moderator", value=moderator, inline=True)
    ...
    async def on_member_ban(self, guild: discord.Guild, user: discord.User):
        ...
        try:
            ...
            await ch.send(embed=emb, delete_after=3600)
