...
class AdminSync(commands.Cog):
    ...
    @app_commands.command(
        ...
        description="Sinkronisasi slash: auto/global/guild/all-guilds/clear_global/clear_guild/copy_global_to_guild.",
    ...
    @app_commands.describe(
        ...
        mode="auto | global | guild | all-guilds | clear_global | clear_guild | copy_global_to_guild"
        ...
        try:
            ...
            if mode == "global":
                ...
                if not guild:
                    ...
                    await inter.followup.send("❌ Harus dipanggil di dalam guild.", ephemeral=True)
