...
try:
    ...
    from satpambot.bot.modules.discord_bot.helpers.banlog_helper import (
        get_banlog_thread,
        send_public_ban_announcement,
    )  # noqa: F401
...
class BanSecure(commands.Cog):
    ...
    @commands.command(
        ...
        help="Simulasi ban yang aman: reply pesan atau sebut member. Contoh: !tb [@user] [alasan]",
