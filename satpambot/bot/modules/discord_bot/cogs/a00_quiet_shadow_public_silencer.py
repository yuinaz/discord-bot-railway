# satpambot/bot/modules/discord_bot/cogs/a00_quiet_shadow_public_silencer.py
# Reduksi spam log dari shadow_public_silencer tanpa menyentuh ENV.
...
class QuietSilencer(commands.Cog):
    def __init__(self, bot):
        ...
        # turunkan level logger agar pesan "blocked send to #rules" tidak muncul
