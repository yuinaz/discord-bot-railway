        ...
        if not self._wh_thread_id:
            ...
            try:
                ...
                await th.send(
                    ...
                    "📜 Thread ini dipakai untuk **WHITELIST**. Kirim `.json` / `.txt` atau gunakan perintah:\n`!wl add <domain|regex>` / `!wl del <domain|regex>` / `!wl show`"  # noqa: E501
        ...
        if not self._bl_thread_id:
            ...
            try:
                ...
                await th.send(
                    ...
                    "⛔ Thread ini dipakai untuk **BLACKLIST**. Kirim `.json` / `.txt` atau gunakan perintah:\n`!bl add <domain|regex>` / `!bl del <domain|regex>` / `!bl show`"  # noqa: E501
