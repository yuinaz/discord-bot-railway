...
class PhashAdmin(commands.Cog):
    ...
    @app_commands.describe(
        ...
        limit_msgs="Messages to scan per inbox thread (default 120)",



        limit_imgs="Max images to hash (default 80)",
    ...
    async def reseed(self, interaction: discord.Interaction, limit_msgs: int = 120, limit_imgs: int = 80):
        ...
        if not threads:
            ...
            await interaction.followup.send("No inbox thread detected.", ephemeral=True)
                ...
                if msg and isinstance(msg.content, str):
                    ...
                    if merged != current:
                        ...
                        try:
                            ...
                            total_new += len(merged) - len(current)
        ...
        await interaction.followup.send(
            ...
            f"Reseed done. Hashed images: {total_imgs}, new pHash appended: ~{total_new}.",
