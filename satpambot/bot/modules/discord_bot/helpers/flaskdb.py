    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        for i in range(6, -1, -1):
            ...
            if gid:
                ...
                c = conn.execute(
                    ...
                    "SELECT COUNT(1) FROM banned_users WHERE guild_id=? AND banned_at BETWEEN ? AND ?",
                ...
                c = conn.execute(
                    ...
                    "SELECT COUNT(1) FROM banned_users WHERE banned_at BETWEEN ? AND ?", (d1s, d2s)
        ...
        if gid:
            ...
            bans = conn.execute(
                ...
                "SELECT username, user_id, guild_id, reason, banned_at FROM banned_users WHERE guild_id=? ORDER BY banned_at DESC LIMIT 8",  # noqa: E501
            ...
            bans = conn.execute(
                ...
                "SELECT username, user_id, guild_id, reason, banned_at FROM banned_users ORDER BY banned_at DESC LIMIT 8"  # noqa: E501
