...
from satpambot.bot.modules.discord_bot.helpers.permissions import (
    is_exempt_user,
...
async def handle_image_classifier(message: discord.Message):
    ...
    try:
        ...
        if is_whitelisted_channel(getattr(message, "channel", None)) or is_exempt_user(
                ...
                if verdict == "black":
                    ...
                    if ch:
                        ...
                        await ch.send(
                            ...
                            f"🧹 [ImageGuard] Deleted blacklisted image from {message.author.mention} in {message.channel.mention}"  # noqa: E501
